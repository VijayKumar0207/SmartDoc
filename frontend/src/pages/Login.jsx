      ...
      <div className="relative group w-full max-w-md">
        ...
        <div className="relative bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
          <div className="mb-10 text-center">
            ...
            <p className="text-slate-400 text-sm">Sign in to access secure document signing</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800 text-center">
            <p className="text-slate-400 text-sm">
              ...
              <Link to="/contact" className="text-blue-400 font-medium hover:text-blue-300 underline underline-offset-4 decoration-blue-500/30 hover:decoration-blue-500 transition-all">
